...
3. Go to "Your-Code" folder and add your image in the Image folder with your GitHub Username. For example, if your username is coder-gits, then rename your image as      coder-gits.png
4. In the "Your-Code" folder, create a file named YourGitHubUserName.html and copy and paste the contents of this file into it.
